#!/usr/local/bin/perl
# =============================================================================
# snmpget.pl - Command to get MIB with SNMP GetRequest via Net::SNMP::Util
# -----------------------------------------------------------------------------
$main::VERSION = '1.02';
# -----------------------------------------------------------------------------
...
snmpget.pl - Command to get MIB values with SNMP GetRequest

=head1 SYNOPSIS

    $ snmpget.pl [OPTIONS] HOST[,HOST[,...]] OID [OID [...]]
...
This program gets MIB values with C<snmpget()> or C<snmpparaget()> of
C<Net::SNMP::Util>.
...
# ---------- kick function ----------
my $func = $opt{P}? 'snmpparaget': 'snmpget';
